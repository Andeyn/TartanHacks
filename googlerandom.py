...
def get_key(num1, num2, noun_path, adj_path):
    ...
    adj = lines2[num2]
    return noun + " " + adj + " person"

    
def main():
    num_random_images = 1
    for i in range(num_random_images):
        keyword = get_key(random.randint(0, 4600), random.randint(0, 1340),"C:\\Users\\schei\\OneDrive\\Documents\\Github\\TartanHacks\\nounlist.txt", "C:\\Users\\schei\\OneDrive\\Documents\\Github\\TartanHacks\\adjlist.txt")
        print("""
        ...
        parser.add_argument('-d', '--directory', default="C:\\Users\\schei\\OneDrive\\Documents\\Github\\TartanHacks\\googleImages", type=str, help='save directory')
